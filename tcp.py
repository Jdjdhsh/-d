...
class xNeonDzai:
    def __init__(self, ip, port, force, threads, protocol):
        ...
        self.protocol = protocol.upper()  # 'TCP' or 'UDP'
...
def main():
    ...
    protocol = 'TCP' if port and port not in [80, 443, 53] else 'UDP'

    print(f"{fg(196)}  {fg(197)}Attack {fg(198)} {fg(200)}{ip}{fg(255)}:{fg(200)}{port} {fg(202)}({protocol}){attr(0)}", end='\r')
